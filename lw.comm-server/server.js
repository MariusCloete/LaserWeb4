                    ...
                    if (config.firmwareWaitTime > 0) {
                        setTimeout(function () {
                            ...
                            if (!firmware) {
                                ...
                                writeLog(chalk.red('Make sure your device is a supported firmware:'), 1);
                                writeLog(chalk.red('  - Grbl (v1.1+)'), 1);
                                writeLog(chalk.red('  - Smoothieware'), 1);
                                writeLog(chalk.red('  - TinyG'), 1);
                                writeLog(chalk.red('  - Repetier, Marlin, MarlinKimbra, or RepRapFirmware'), 1);
                                writeLog(chalk.red('Check the log above for "UNRECOGNIZED FIRMWARE RESPONSE" messages'), 1);
                                writeLog(chalk.red('================================================'), 1);
